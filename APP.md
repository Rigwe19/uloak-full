...
- 5 regions: `nigeria (NG, NGN ₦15,000)`, `rest_of_africa (ZA/KE/…, USD US$19)`, `uk (GB, GBP £29)`, `us_rest_of_world (US,CA,AU,NZ,SG,…, USD US$35)`, `europe (FR/DE,…, EUR €35)`. Family Archive monthly/yearly + savings in same table. Minor units (kobo/cents). `us_rest_of_world` is where **Canada** lives — no separate CA row.
