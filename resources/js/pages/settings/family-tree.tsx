...
export default function SettingsFamilyTree({
    person,
    graph,
}: SettingsFamilyTreeProps) {
...
function TreeView({
    ...
    if (!nodes || nodes.length === 0) {
        return <p className="text-xs text-text-muted italic">None recorded</p>;
    }
