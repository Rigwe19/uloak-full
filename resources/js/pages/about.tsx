...
export default function About({ page }: Props) {
    ...
    const hero = content?.hero || {
        ...
        subtitle:
            'Ulo of Stories is a storytelling movement based in the UK. We exist to preserve the stories that make us human — through film, technology, community, and research.',
    };
    ...
    const missionVision = content.mission_vision || {
        mission:
            'To preserve the stories that make us human — through film, archive, and technology — so that no voice is ever lost to time.',
            ...
            <div className="bg-bg-dark text-text-primary selection:bg-accent-gold/30">
                ...
                <section className="bg-bg-dark px-6 py-24 md:px-12 lg:px-24">
                    <div className="mx-auto max-w-7xl">
                        <div className="grid grid-cols-1 gap-20 lg:grid-cols-2">
                            ...
                            >
                                <h2 className="text-3xl leading-tight font-bold text-text-primary italic md:text-4xl lg:text-5xl">
                                    {origin.quote}
                                </h2>
                            </motion.div>
                            <motion.div
                ...
                <section className="bg-surface/30 px-6 py-32 md:px-12 lg:px-24">
                    <div className="mx-auto max-w-7xl">
                        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
                            ...
                            >
                                <span className="mb-6 block text-[10px] font-bold tracking-widest text-accent-gold uppercase">
                                    Our Mission
                                </span>
                ...
                <section className="px-6 py-32 md:px-12 lg:px-24">
                    <div className="mx-auto max-w-7xl text-center">
                        <h2 className="mb-20 text-4xl font-bold tracking-tight text-text-primary md:text-5xl">
                        ...
                        <div className="grid grid-cols-1 items-center gap-20 lg:grid-cols-2">
                            ...
                            <div className="space-y-12">
                                ...
                                >
                                    ...
                                    <p className="text-2xl leading-relaxed text-text-muted italic">
                                        {founder.quote}
                                    </p>
                                </motion.div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="mb-20 text-center">
                            <h2 className="text-4xl font-bold tracking-tight text-text-primary md:text-5xl">
                                The Expressions of Ulo of Stories.
                            </h2>
                            <p className="mt-6 text-xl text-text-muted">
                                One mission, many forms.
                            </p>
                        </div>
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {expressions.map((expression: any, i: number) => {
                                const IconComponent =
                                    iconMap[
                                        expression.icon as keyof typeof iconMap
                                    ] || Shield;
                                ...
                                return (
                                    ...
                                    >
                                        <IconComponent
                                            className="mb-8 text-accent-gold"
                                            size={32}
                                        />
                ...
                <section className="px-6 py-32 md:px-12 lg:px-24">
                    ...
                    >
                        ...
                        <p className="mx-auto mt-8 max-w-xl text-xl font-medium opacity-80">
                            Whether for your family, your community, or your
                            heritage — we are here to help you preserve what
                            matters.
                        </p>
                        <div className="mt-12 flex flex-wrap justify-center gap-6">
                            ...
                            <Button
                                variant="outline"
                                className="h-16 rounded-full border-black/20 bg-transparent px-12 text-lg font-bold text-black hover:bg-black/5"
                            >
                                Browse Projects
                            </Button>
                        </div>
