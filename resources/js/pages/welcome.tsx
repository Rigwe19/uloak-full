        ...
        <GuestLayout>
            ...
            <div className="bg-bg-dark text-text-primary selection:bg-accent-gold/20">
                    ...
                    <div className="mx-auto max-w-7xl px-6 md:px-8 w-full z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            ...
                            <div className="lg:col-span-6 text-left space-y-8 max-w-2xl">
                                <div className="inline-flex items-center gap-2 rounded-full border border-accent-gold/20 bg-accent-gold/5 px-4 py-1.5">
                                    <Sparkles size={14} className="text-accent-gold" />
                                    <span className="text-xs font-bold tracking-widest text-accent-gold uppercase">
                                        Ulo means "house" in Igbo.
                                    </span>
                                </div>
                ...
                <section id="how-it-works" className="py-24 border-t border-border-subtle bg-surface/10">
                    <div className="mx-auto max-w-7xl px-6 md:px-8">
                        <div className="text-center max-w-3xl mx-auto mb-20">
                            ...
                            <h2 className="font-serif text-4xl font-bold tracking-tight text-text-primary sm:text-5xl">
                                Create a Room. Invite your people. Start the story.
                            </h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative">
                            ...
                            {[
                                { num: "01", step: "Create a Room", desc: "Create a private space for the story you want to gather." },
                                ...
                                <div key={index} className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left space-y-4">
                                    <div className="h-16 w-16 rounded-2xl border border-border-subtle bg-bg-dark flex items-center justify-center text-accent-gold font-serif text-xl font-bold shadow-xs">
                                        {item.num}
                                    </div>
                    ...
                    <div className="mx-auto max-w-7xl px-6 md:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                            <div className="lg:col-span-5 space-y-6">
                                <span className="text-xs font-bold tracking-[0.2em] text-accent-gold uppercase block">
                                    The Differentiator
                                </span>
                                <h2 className="font-serif text-4xl leading-tight font-bold text-text-primary sm:text-5xl">
                            ...
                            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="border border-border-subtle bg-surface/30 rounded-3xl p-6 flex flex-col justify-between">
                                    <div>
                                ...
                                <div className="border border-accent-gold/25 bg-bg-dark rounded-3xl p-6 flex flex-col justify-between shadow-xl">
                                    <div>
                ...
                <section className="py-24 border-t border-border-subtle bg-surface/10">
                    <div className="mx-auto max-w-4xl px-6 md:px-8 text-center space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto pt-6 text-left">
                            <div className="bg-surface/50 border border-border-subtle p-5 rounded-2xl space-y-3">
                    ...
                    <div className="mx-auto max-w-5xl px-6 md:px-8 border border-border-subtle/50 bg-bg-dark rounded-3xl p-8 md:p-12">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                            <div className="md:col-span-8 space-y-4">
                                <span className="text-[10px] font-bold text-accent-gold uppercase tracking-[0.2em] block">
                                    Supporting Service
                                </span>
                                ...
                                <p className="text-base text-text-muted leading-relaxed max-w-xl font-light">
                ...
                <section className="py-24 border-t border-border-subtle">
                    <div className="mx-auto max-w-7xl px-6 md:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                            <div className="lg:col-span-5 relative aspect-4/3 overflow-hidden rounded-3xl bg-surface">
                                <img
                ...
                <section className="py-24 border-t border-border-subtle bg-bg-dark text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-8 space-y-8">
                        ...
                        <p className="text-lg text-text-muted font-light leading-relaxed max-w-xl mx-auto">
                            Create a Room, invite your people and keep the meaning together.
                        </p>
