...
export default function Dashboard({ dashboardData, auth }: DashboardProps) {
    ...
    const [createMode, setCreateMode] = useState<'room' | 'event'>(
        INITIAL_MODE,
    );
    ...
    const categories = useMemo(
        () => [
            ...
            },
            {
                name: 'Voices',
                icon: MessageSquare,
                count: stats.find((s) => s.name === 'Audio')?.count || 0,
            },
            {
                name: 'Members',
                icon: Share2,
                count:
                    stats.find((s) => s.name === 'Family Members')?.count || 0,
            },
            {
                name: 'Documents',
                icon: Files,
                ...
                <section className="mt-20">
                    <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-xs text-text-muted md:text-sm">
                                Events and projects you've created for clients.
                            </p>
                        </div>
                        {clients.length > 0 && (
                        ...
                        {events.map((event) => (
                            ...
                            >
                                ...
                                <div className="absolute right-0 bottom-0 left-0 z-10 flex flex-col gap-4 p-8">
                                    <Badge className="w-fit bg-accent-gold/20 text-accent-gold transition-colors duration-500">
                                        {event.event_date
                                            ? new Date(
                                                  event.event_date,
                ...
                <section className="mt-20">
                    <div className="mb-10 flex items-center justify-between">
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-xs text-text-muted md:text-sm">
                                The latest artifacts preserved in your heritage.
                            </p>
                        </div>
                        <Button
                            variant="ghost"
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                        {recentStories.map((story) => (
                            <div
                                ...
                                onClick={() =>
                                    setViewerIndex(
                                        recentStories.findIndex(
                                            (s) => s.id === story.id,
                                        ),
                                    )
                                }
                                className="group relative aspect-square cursor-pointer overflow-hidden rounded-[32px] border border-white/5 bg-surface/40"
                            >
                                <img
                                    src={story.thumbnail}
                                    ...
                                    {isBusinessAdmin ? (
                                        <>
                                            ...
                                            <p className="text-sm leading-relaxed text-text-muted">
                                                An event gathers memories around
                                                a special occasion or moment in
                                                time.
                                            </p>
                                        </>
                                    ) : (
                                        <>
                                            ...
                                            <p className="text-sm leading-relaxed text-text-muted">
                                                Each room is a dedicated
                                                sanctuary for a family branch or
                                                heritage collection.
                                            </p>
                                        </>
                                    )}
                                ...
                                >
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            placeholder={
                                                createMode === 'room'
                                                    ? 'e.g., The Heritage Hall'
                                                    : "e.g., Grandma's 80th Birthday"
                                            }
                                            value={data.name}
                                            onChange={(e) =>
                                        ...
                                        <textarea
                                            placeholder={
                                                createMode === 'room'
                                                    ...
                                                    : 'Describe this special occasion...'
                                            }
                                            rows={3}
                                        ...
                                        <div className="space-y-3 rounded-2xl border border-accent-gold/20 bg-accent-gold/5 p-5">
                                            ...
                                            <p className="text-[10px] leading-relaxed text-text-muted">
                                                ...
                                                {createMode === 'room'
                                                    ? 'project'
                                                    : 'event'}{' '}
                                                to a client. The client will be
                                                able to view it from their
                                                portal.
                                            </p>
                                            ...
                                            {showClientForm && (
                                                <div className="space-y-3 rounded-xl border border-white/10 bg-bg-dark/50 p-4">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full rounded-xl border border-white/10 bg-bg-dark px-4 py-2.5 text-sm text-text-primary transition-colors outline-none focus:border-accent-gold/50"
                                                    />
                                                    <input
                                                        type="email"
                                                        placeholder="Email *"
