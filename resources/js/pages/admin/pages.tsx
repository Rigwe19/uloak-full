...
import { FileText, Edit3, Eye, Globe, Clock, Plus } from 'lucide-react';
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-text-muted">
                            Manage and edit the dynamic content across the Uloak
                            platform.
                        </p>
                    </div>
                    ...
                    {pages.map((page, i) => (
                        ...
                        >
                            <div className="flex items-center gap-6">
                                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-white/5 bg-bg-dark text-text-muted shadow-inner transition-colors group-hover:text-accent-gold">
                                    <FileText size={28} />
                                </div>
                            ...
                            <div className="flex w-full items-center justify-between gap-4 md:w-auto">
                                <span
                                    className={`inline-flex rounded-full px-2.5 py-1 text-[9px] font-bold tracking-widest uppercase ${
                                        page.is_published
