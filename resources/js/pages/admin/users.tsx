                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left">
                            <thead className="border-b border-border-subtle bg-surface/50">
                                <tr>
                                    <th className="px-8 py-5 text-[10px] font-bold tracking-widest text-text-muted uppercase">Custodian</th>
                                    <th className="px-8 py-5 text-[10px] font-bold tracking-widest text-text-muted uppercase">Role</th>
                                    <th className="px-8 py-5 text-[10px] font-bold tracking-widest text-text-muted uppercase">Joined</th>
                                    <th className="px-8 py-5 text-right text-[10px] font-bold tracking-widest text-text-muted uppercase">Actions</th>
                                </tr>
                            </thead>
                                    ...
                                    >
                                        ...
                                        <td className="px-8 py-5">
                                            {user.is_admin ? (
                                                ...
                                                <div className="flex items-center gap-2 text-text-muted">
                                                    <Shield size={14} />
                                                    <span className="text-[10px] font-bold tracking-widest uppercase">User</span>
                                                </div>
                                            )}
                                        </td>
                                        ...
                                        <td className="px-8 py-5 text-right">
                                            <div className="flex items-center justify-end gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                                                <button className="rounded-lg p-2 text-text-muted transition-all hover:bg-surface hover:text-accent-gold" title="Edit User">
                                                    <Edit3 size={16} />
                                                </button>
                                                <button className="rounded-lg p-2 text-text-muted transition-all hover:bg-surface hover:text-red-400" title="Deactivate User">
                                                    <UserX size={16} />
                                                </button>
