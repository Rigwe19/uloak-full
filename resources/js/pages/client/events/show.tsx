        ...
        <div className="min-h-screen bg-bg-dark">
            ...
            <div className="mx-auto max-w-7xl p-5 pb-32 md:p-8 lg:p-16">
                <header className="mb-12">
                    <Link
                        href={dashboard().url}
                        className="group mb-8 inline-flex items-center gap-2 text-text-muted transition-colors hover:text-text-primary"
                    >
                        <ArrowLeft
                            size={18}
                        ...
                        {stories.map((story) => (
                            ...
                            >
                                <div className="relative aspect-4/3 overflow-hidden">
                                    ...
                                    />
                                    <div className="absolute top-4 left-4 rounded-full border border-white/10 bg-bg-dark/60 px-3 py-1 text-[10px] font-bold tracking-widest uppercase backdrop-blur-md">
                                        {story.type}
                                    </div>
                                </div>
                                <div className="flex grow flex-col justify-between gap-4 p-6">
                                    <div className="space-y-2">
                                        ...
                                        {story.description && (
                                            <p className="line-clamp-2 text-sm text-text-muted italic">
                                                "{story.description}"
                                            </p>
                                        )}
                                    </div>
