...
export default function Contact({ page }: Props) {
    ...
    const hero = content.hero || {
        ...
        subtitle:
            "Whether you're a family with a story to tell or an organization looking to partner — we'd love to hear from you.",
    };
    ...
    const contactInfo = content.contact_info || [
        {
            label: 'Email',
            value: 'hello@ulo of stories.co.uk',
            icon: 'Mail',
            link: 'mailto:hello@ulo of stories.co.uk',
        },
        {
            label: 'Phone',
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid grid-cols-1 gap-20 lg:grid-cols-2">
                                ...
                                {sent ? (
                                    ...
                                    >
                                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                                            <div className="space-y-3">
                                                ...
                                                <input
                                                    type="text"
                                                    required
                                                    className="w-full rounded-2xl border border-white/5 bg-bg-dark px-6 py-4 text-sm transition-all outline-none focus:border-accent-gold/50"
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <select
                                                className="w-full appearance-none rounded-2xl border border-white/5 bg-bg-dark px-6 py-4 text-sm transition-all outline-none focus:border-accent-gold/50"
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <textarea
                                                rows={5}
                                                required
                                                className="w-full resize-none rounded-2xl border border-white/5 bg-bg-dark px-6 py-4 text-sm transition-all outline-none focus:border-accent-gold/50"
                            ...
                            <div className="space-y-16">
                                    ...
                                    <div className="grid gap-12">
                                        {contactInfo.map(
                                            (info: any, i: number) => {
                                                const IconComponent =
                                                    iconMap[
                                                        info.icon as keyof typeof iconMap
                                                    ] || Mail;
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            <p className="mb-1 text-[10px] font-bold tracking-widest text-accent-gold uppercase">
                                                                {info.label}
                                                            </p>
                                                            <a
                                                                href={info.link}
                                                                className="text-2xl font-bold transition-colors hover:text-accent-gold"
                                                            >
                                                                {info.value}
                                                            </a>
                                                        </div>
                                ...
                                <div className="h-[400px] overflow-hidden rounded-[40px] border border-white/5 opacity-80 grayscale invert-[0.9] transition-all hover:opacity-100 hover:grayscale-0 hover:invert-0">
                                    <iframe
