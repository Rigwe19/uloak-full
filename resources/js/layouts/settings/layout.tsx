...
import { User, Shield, Palette, Home, Lock } from 'lucide-react';
...
export default function SettingsLayout({ children }: PropsWithChildren) {
    ...
    return (
        <div className="mx-auto max-w-6xl p-5 pb-32 md:p-8 md:pb-8 lg:p-16">
            <motion.div
                        ...
                        {sidebarNavItems.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    href={item.href}
                                    className={cn(
                                        'flex shrink-0 items-center gap-2.5 rounded-xl p-3.5 text-[10px] font-bold transition-all md:gap-3 md:p-4 md:text-sm',
                                        active
