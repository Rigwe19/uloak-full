            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-10">
                    ...
                    >
                        ...
                        {/* Content */}
                        <div className="custom-scrollbar h-[calc(100%-100px)] overflow-y-auto p-8">
                            {/* Metrics Grid */}
                            <div className="mb-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                                {metrics.map((metric, i) => (
                                    <motion.div
                                        ...
                                        className="rounded-3xl border border-white/5 bg-white/2 pt-6 pr-6 pb-6 pl-6"
                                    >
                                        <div className="mb-4 flex items-center justify-between">
                                            ...
                                            <div
                                                className={`flex items-center gap-1 text-xs font-bold ${metric.isUp ? 'text-green-400' : 'text-red-400'}`}
                                            >
                                                {metric.isUp ? (
                                    ...
                                    <div className="mb-8 flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-text-muted">
                                                Monthly revenue for the last 7
                                                months
                                            </p>
                                        </div>
                                        <div className="flex items-center gap-2 rounded-xl bg-white/5 px-3 py-1.5 text-xs font-medium text-text-muted">
                                        ...
                                        {subscriberData.map((d, i) => (
                                            ...
                                            >
                                                <motion.div
                                                    initial={{ height: 0 }}
                                                    animate={{
                                                        height: `${(d / Math.max(...subscriberData)) * 100}%`,
                                                    }}
                                                    transition={{
                                                        delay: i * 0.1,
                                                        duration: 0.8,
                                                    }}
                                                    className="w-full max-w-[40px] rounded-t-lg bg-accent-gold/20 transition-colors group-hover:bg-accent-gold/40"
                                                />
                                                <div className="absolute -top-8 rounded border border-white/10 bg-surface px-2 py-1 text-[10px] font-bold text-text-primary opacity-0 transition-opacity group-hover:opacity-100">
                                                    {d}
                                                </div>
                                            </div>
                                        ))}
                                    ...
                                    <table className="w-full text-left text-sm">
                                        <thead>
                                            <tr className="border-b border-white/5 bg-white/5">
                                                <th className="px-6 py-4 font-bold text-text-primary">
                                                    Member
                                                </th>
                                                <th className="px-6 py-4 font-bold text-text-primary">
                                                    Status
                                                ...
                                                >
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-3">
                                                            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-accent-gold/10 text-xs font-bold text-accent-gold">
                                                                {
                                                                    [
                                                                        'JS',
                                                                        'MD',
