...
export default function TimelineEvent({ event }: { event: TEvent }) {
    return (
        <motion.div
            ...
            className="relative border-l-2 border-accent-gold/30 pl-6 pb-8 last:pb-0"
        >
            <div className="absolute -left-[9px] top-0 h-4 w-4 rounded-full border-2 border-accent-gold bg-bg-dark" />
