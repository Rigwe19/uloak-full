...
export function AnnexEventMemoryModal({
    isOpen,
    onClose,
    event,
    onSuccess,
    ...
    const handleSubmit = (e?: React.FormEvent) => {
        ...
        if (
            ...
            uuids.forEach((uuid, index) => {
                ...
                formData.append(
                    'title',
                    data.title || `${event.name} Memory ${index + 1}`,
                );
                ...
                router.visit(window.location.pathname, {
                    ...
                    onSuccess: (page) => {
                        window.dispatchEvent(
                            new CustomEvent('feed:reset', {
                                detail: {
                                    stories: (page.props as any).stories ?? [],
                                },
                            }),
                        );
                    },
                    ...
                    <div className="space-y-6">
                        <div className="mb-8">
                            ...
                            <p className="text-sm leading-relaxed text-text-muted">
                                What format does this event legacy take? Select
                                a media type to continue.
                            </p>
                        </div>
                ...
                {step === 'success' && (
                    <div className="py-8 text-center">
                        ...
                        <p className="mb-8 text-text-muted">
                            Your memory has been successfully added to{' '}
                            {event.name}.
                        </p>
                        <Button
                            variant="primary"
