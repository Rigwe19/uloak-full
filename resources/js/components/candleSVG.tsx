...
export default function CandleSVG({
    ...
    return (
        ...
        >
            ...
            >
                <path
                    d="M28 9 C23.5 17 20 22 20 27.5 C20 34 23.8 38 28 38 C32.2 38 36 34 36 27.5 C36 22 32.5 17 28 9Z"
                    fill={`url(#fo${id})`}
                />
            </g>
            ...
            <g
                style={{
                    transformOrigin: '50% 100%',
                    animation: `candleInner 1.5s ease-in-out infinite`,
                    animationDelay: `${delay + 0.18}s`,
                }}
            >
                <path
                    d="M28 19 C26.2 23.5 25.2 26 25.2 29.5 C25.2 33 26.5 35.5 28 35.5 C29.5 35.5 30.8 33 30.8 29.5 C30.8 26 29.8 23.5 28 19Z"
                    fill={`url(#fi${id})`}
                    opacity="0.85"
                />
            </g>
