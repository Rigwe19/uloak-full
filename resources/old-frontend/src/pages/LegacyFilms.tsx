...
export default function LegacyFilms() {
    const services = [
        {
        ...
        <div className="bg-bg-dark pt-20">
            ...
            <section className="relative flex h-[80vh] items-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 z-10 bg-gradient-to-r from-bg-dark via-bg-dark/80 to-transparent" />
                    <img
                ...
                <div className="relative z-20 mx-auto w-full max-w-7xl px-8">
                    ...
                    >
                        ...
                        <p className="mb-12 max-w-xl text-xl leading-relaxed font-light text-text-muted md:text-2xl">
                            Premium storytelling services — documentary film,
                            oral history, heritage photography, and more. We
                    ...
                    <div className="mb-20 flex flex-col justify-between gap-8 md:flex-row md:items-end">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-lg text-text-muted">
                                ...
                                services designed to capture and preserve the
                                essence of who you are.
                            </p>
                        </div>
                        <div className="mx-12 mb-6 hidden h-px flex-grow bg-border-subtle md:block" />
                    </div>
            ...
            <section className="relative bg-surface/20 py-32">
                <div className="mx-auto max-w-7xl px-8">
                    ...
                    <div className="relative">
                        {/* Connection Line */}
                        <div className="absolute top-1/2 left-0 hidden h-px w-full bg-gradient-to-r from-transparent via-border-subtle to-transparent lg:block" />
                            ...
                            {steps.map((step, i) => (
                                ...
                                >
                                    <div className="relative mb-8 inline-block">
                                        <span className="pointer-events-none absolute -top-8 -left-4 text-5xl font-bold text-text-muted/5 transition-colors duration-500 select-none group-hover:text-accent-gold/5 lg:text-7xl">
                                            {step.id}
                                        </span>
            ...
            <section className="bg-bg-dark py-32">
                <div className="mx-auto max-w-7xl px-8">
                    <div className="flex flex-col overflow-hidden rounded-[3rem] border border-border-subtle bg-surface lg:flex-row">
                        <div className="flex flex-col justify-center bg-gradient-to-br from-accent-gold/5 to-transparent p-12 lg:w-1/2 lg:p-20">
                            ...
                            <p className="mb-12 text-lg text-text-muted">
                                Fill in the form and we'll be in touch within 48
                                hours to discuss your project. We're looking
                            ...
                            <form className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select className="w-full appearance-none rounded-xl border border-border-subtle bg-surface px-4 py-3 text-sm transition-all outline-none focus:border-accent-gold">
                                        <option>Life Story Documentary</option>
                                        <option>Heritage Photography</option>
                                        <option>Oral History Recording</option>
