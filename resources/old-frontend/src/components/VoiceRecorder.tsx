        ...
        if (state === 'recording' && canvasRef.current && streamRef.current) {
            ...
            const draw = () => {
                ...
                for (let i = 0; i < bufferLength / 2; i++) {
                    // We use frequency data, but we could also use time domain for a waveform
                    ...
                    // Gradient-like effect based on intensity
            ...
            >
                ...
                <div className="mb-8 text-center md:mb-12">
                    <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-accent-gold/10 md:mb-6 md:h-16 md:w-16">
                        <Volume2
                            className="text-accent-gold md:size-[32px]"
                            size={24}
                        />
                    </div>
                ...
                <div className="mb-8 flex min-h-[180px] flex-col items-center justify-center md:mb-12 md:min-h-[200px]">
                    {state === 'idle' && (
                        ...
                        >
                            <Mic size={32} className="md:size-[40px]" />
                    ...
                    {state === 'saving' && (
                        <div className="flex flex-col items-center gap-6">
                            <Loader2
                                className="animate-spin text-accent-gold md:size-[48px]"
                                size={32}
                            />
