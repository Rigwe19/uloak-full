        ...
        <>
            ...
            >
                ...
                <div className="pointer-events-none absolute inset-0 z-20 opacity-0 transition-opacity duration-700 group-hover:opacity-100">
                    ...
                    <div className="absolute top-0 left-1/2 h-[1px] w-2/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-accent-gold/50 to-transparent blur-[2px]" />
                </div>
            </motion.div>
                ...
                {showDetail && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 lg:p-8">
                        ...
                        >
                            ...
                            <div className="relative flex flex-grow flex-col justify-center bg-surface p-10 lg:p-16">
                                <button
                                    onClick={() => setShowDetail(false)}
